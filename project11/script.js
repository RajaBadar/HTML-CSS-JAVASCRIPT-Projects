...
//function to start countdown or decrement timer by 1
...
//Event listener
//1.listen for input in the userword input element
userWord.addEventListener('input', e => {
 ...
 //check to see if userInput matches the random word
    if(userInput === randomWord){
        //if the has typed the correct word generate a new word 
        renderWord();
...
//2.listen for click on the settings btn
